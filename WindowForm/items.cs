...
namespace WindowForm
{
    public partial class items : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            con.Open();
            SqlCommand cmd = new SqlCommand("Insert into items Values (@items,@categories,@price,@stock,@manufacturer)", con);
            cmd.Parameters.AddWithValue("@Items", textitems.Text);
            cmd.Parameters.AddWithValue("@Categories", textcategories.Text);
